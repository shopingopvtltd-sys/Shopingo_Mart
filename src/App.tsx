...
<div className="order-1 lg:order-2 animate-fadeInRight flex flex-wrap gap-10 justify-center">
  ...
  <div className="flex flex-col items-center bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
    ...
    <div className="flex items-center gap-2">
      ...
      <a href="https://www.instagram.com/rahul_rauniyar2254" target="_blank" rel="noopener noreferrer" className="hover:underline">
        Instagram
      </a>
    </div>
    <div className="flex items-center gap-2">
  ...
  <div className="flex flex-col items-center bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
    ...
    <div className="flex items-center gap-2">
      <Instagram className="w-5 h-5 text-pink-500" />
      <a href="https://www.instagram.com/its_prem12" target="_blank" rel="noopener noreferrer" className="hover:underline">
        Instagram
      </a>
    </div>
    <div className="flex items-center gap-2">
